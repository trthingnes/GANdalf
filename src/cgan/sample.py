...
parser.add_argument("--file", required=True, help="The name of the generator model file to use (format: [name].pt)")
opt = parser.parse_args()

generator = load_state(Generator(img_size_in=10, img_size_out=28, n_labels=10), opt.file)
sqrt_samples = 5
